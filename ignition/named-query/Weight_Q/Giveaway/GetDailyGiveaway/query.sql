...
select 
   DATEFROMPARTS(YEAR(a.local_shift_date), MONTH(a.local_shift_date), DAY(a.local_shift_date)) AS production_date, 
...
GROUP BY
    a.site_id,
    DATEFROMPARTS(YEAR(a.local_shift_date), MONTH(a.local_shift_date), DAY(a.local_shift_date)),
    a.line_id,
    a.filler_id,
    s.sku_code,
    s.sku_description,
