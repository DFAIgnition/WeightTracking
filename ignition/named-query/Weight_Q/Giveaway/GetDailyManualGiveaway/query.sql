...
select  
    DATEFROMPARTS(YEAR(a.local_shift_date), MONTH(a.local_shift_date), DAY(a.local_shift_date)) AS production_day, a.unit_name, a.unit_id, 
...
group by DATEFROMPARTS(YEAR(a.local_shift_date), MONTH(a.local_shift_date), DAY(a.local_shift_date)),a.unit_name, a.unit_id
