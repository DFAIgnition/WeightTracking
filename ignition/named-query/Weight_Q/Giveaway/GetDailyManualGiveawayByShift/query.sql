...
group by DATEFROMPARTS(YEAR(a.local_shift_date), MONTH(a.local_shift_date), DAY(a.local_shift_date)), a.shift_number, a.unit_name, a.unit_id
order by DATEFROMPARTS(YEAR(a.local_shift_date), MONTH(a.local_shift_date), DAY(a.local_shift_date)) desc, a.shift_number desc
